...
/***/ function(module, exports, __webpack_require__) {
	...
	// import {List} from '../components/provide-list.jsx';
	// import reducers from '../reducers/reducers.js';
	// import getData from './loader.js';
	// import {set, transition} from '../actions/actions.js';
	...
	// const render = () => {
	//     ReactDOM.render(<List store={store}/>, document.getElementById('content'));
	// }

	// store.subscribe(render);

	// let content = getData("http://rti-gradebook.dev.architech.nyc:3000/api/students/list")
	//     .then((content) => {
	//         return JSON.parse(content);
	//     }).then((content) => {
	//         store.dispatch(set(content, 0))
	//     }).then((content) => {
	//         render();
	//     });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchLayout = __webpack_require__(228);
	...
	var _userProfile = __webpack_require__(231);

	var _userProfile2 = _interopRequireDefault(_userProfile);

	var _widgetList = __webpack_require__(232);
